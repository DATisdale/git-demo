...
let restuarants = ['Big Brutus', 'Steak & Shake', 'Olive Garden', 'Tacos & Brunch', 'KickBackJacks', 'Tuesdays', 'Burger Work', 'Munchies']
...
let randomDestination =('Las Vegas')
let randomRestuarant =('Big Brutus')
